...
public class ReceivedOrderListAdapter extends RecyclerView.Adapter<ReceivedOrderListAdapter.ViewHolder> {
    Context context;
    ArrayList<OrdersModel> ordersModels;
    DatabaseReference databaseImages;
    public ReceivedOrderListAdapter(Context context, ArrayList<OrdersModel> OrdersModels) {
    ...
    @NonNull
    @Override
    public ReceivedOrderListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void updateList(ArrayList<OrdersModel> ordersModels){
        this.ordersModels=ordersModels;
